const strings = {
  ...
  in_app_disclosure: "This App collects your location information in the background, to assist Caregivers to provide timely care and support emergency response actions.",
  email: "Email",
  password: "Password",
  ...
  safe_home: "Safe@Home",
  safe_work: "Safe2Work",
  safe_home_dec: "An easy-to-use mental health and well-being intelligent platform for seniors & caregivers, that aims to track the progress of early cognitive decline based on risk-levels. ",
  safe_work_dec: "A non-invasive platfrom offering real-time risk monitoring, early detection and health screening of potential infection, ensuring care organizations and their staff members are Safe2Work.",
  ...
  info_text: 'Be honest, a little more excercise and control on fats in diet could make you more healthier',
  ...
  select_device: "Select a device to take in a reading from or enter the information yourself",
  temp_note: "Note: Temperature must be entered manually",
  pulse_rate_info: "The number of times your heart beats per minute. Measured in beats per minute (bpm).",
  oxigen_info_info: "The percentage of hemoglobin in the blood that is saturated with oxygen, otherwise known as your SpO2 or O2 sat level. Measured in %.",
  body_temperature_info: "The temperature of your body. Measured in degrees Celsius or Fahrenheit. To change Celsius or Fahrenheit go to profile",
  ...
  result_screen_bottom:"Our infection Risk Assessment follows the COVID-19 screening guidlines and symptoms detection of Ontario Ministry of Heatlh (Ontario Regulation 364/20) and guidlines of CDC risk assessment & symptoms testing",
  result_screen_bottom_link_one:'http://www.health.gov.on.ca/en/pro/programs/publichealth/coronavirus/docs/wrokplace_screening_tool_guidance.pdf',
  result_screen_bottom_link_two:'http://www.cdc.gov/coronavirus/2019-ncov/symptoms-testing/symptoms.html;',
  ...
  manuallyReadings_info: {
    heartRate: 'Enter the Heart Rate value in BPM.',
    heartRateVarability: 'Enter the Heart Rate Variability value in ms.',
    bodyTemp: 'Enter the Body Temperature value and select the required unit from the drop down on.',
    oxygenSaturation: 'Enter the Oxygen Saturation value in %.',
    bloodGlucose: 'Enter the Blood Glucose value in mg/dL.',
    stepCount: 'Enter the number of Steps.',
    sleep: 'Enter the Sleep value in hours.',
    weight: 'Enter the Weight value and select the required unit from the drop down.',
    fall: 'Enter the number of Falls within the previous day.',
    systolicBP: 'Enter the Systolic Blood Pressure value in mmHg.',
    diastolicBP: 'Enter the Diastolic Blood Pressure value in mmHg.',
  }
};
